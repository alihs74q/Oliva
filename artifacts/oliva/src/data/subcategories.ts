...
export const coldDrinksSubcategories: Subcategory[] = [
  {
    ...
    drinks: [
      { name: 'Foral Fusion', description: 'A vibrant blend of fresh fruit flavors.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Remove_cub_keep_berry_202607240514-HSn503Mf9tacmA8abgIBzX6GJZV2aA.jpeg', recipe: 'Mixed fruits · Fruit juice · Floral flavor · Ice' },
      { name: 'Mango', description: 'Ripe mango blended to perfection.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_with_mango_smoothies_202607240514-6etjX8dIMf211zgwAI0qADkDRfXIYK.jpeg', recipe: 'Mango · Fruit juice · Ice' },
      { name: 'Strawberry', description: 'Fresh strawberries, creamy and sweet.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_with_strawberry_smoothies_202607240515-ErzxOqHxsILoXGGWoxfURuwvjKOfLR.jpeg', recipe: 'Strawberries · Fruit juice · Ice' },
      { name: 'Passion Fruit', description: 'Tropical passion fruit, tangy and refreshing.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_with_passion_fruit_smoothie_202607240515-gcFfTy9CTasTxniOrouIbIFZszEfSE.jpeg', recipe: 'Passion fruit · Fruit juice · Ice' },
    ],
  },
  {
    id: 'milk-shake',
    ...
    drinks: [
      { name: 'Cookies & Cream', description: 'Crushed cookies blended into silky cream.', price: '$4.50', lbpPrice: '400,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Make_cookies_brown_not_oreo_202607240518-iKktANVkffo9wb6QbbcuqxY2ChOrwx.jpeg', recipe: 'Vanilla ice cream · Cold whole milk · Crushed Oreo cookies · Chocolate sauce' },
      { name: 'Strawberry Whip', description: 'Fresh strawberries with whipped cream.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Strawberry_whip_milkshakes_202607240519-XGTJ17Ap1la3ozcF0mlFK2Y7N9HQqZ.jpeg', recipe: 'Vanilla ice cream · Cold whole milk · Strawberry purée · Whipped cream' },
      { name: 'Choco-Nut Milkshake', description: 'Chocolate and nut blend, rich and creamy.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_with_choco_nut_202607240519-6mC8PWh61UYLCgVfOb8SdAZVcD0oJo.jpeg', recipe: 'Vanilla ice cream · Cold whole milk · Chocolate · Hazelnut flavor' },
      { name: 'Vanilla Milkshake', description: 'Classic vanilla bean milkshake.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_with_vanilla_milkshakes_202607240520-CSxRiddqcNF8XKDMaS0NDdhwTaSgYp.jpeg', recipe: 'Vanilla ice cream · Cold whole milk · Vanilla flavor' },
      { name: 'Lotus Milkshake', description: 'Lotus biscuit blended into creamy indulgence.', price: '$4.50', lbpPrice: '400,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_with_lotus_milkshake_202607240521-VWPZhDpaqRMBGqeEMWZyjAZrVKWVQA.jpeg', recipe: 'Vanilla ice cream · Cold whole milk · Lotus Biscoff spread · Crushed Lotus biscuits' },
      { name: 'Oliva Milkshake', description: 'Our secret house-special signature shake.', price: '$5', lbpPrice: '450,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Make_drink_sooooo_blur_202607240524-oqfptwROqTmiIQ6F4op2kh9LR8JRA6.jpeg', recipe: '????? try it and find out' },
    ],
  },
  {
    id: 'coffee-frappe',
    ...
    drinks: [
      { name: 'Mocha Frappe', description: 'Rich mocha blended with ice and cream.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-BQDkBVR6vWGnbaHOj7SOW5NopJgyKD.png', recipe: 'Double espresso · Cold whole milk · Chocolate sauce · Ice · Blended until smooth' },
      { name: 'Caramel Frappe', description: 'Smooth caramel blended with ice and coffee.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-DD355iO6F299UbnMlZ1HbkfhQNt4Sd.png', recipe: 'Double espresso · Cold whole milk · Caramel syrup · Ice · Blended until smooth' },
      { name: 'Vanilla Frappe', description: 'Classic vanilla blended with ice and coffee.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Q3TPoUv7PqvQEPzIy7QPORCPPdjfeg.png', recipe: 'Double espresso · Cold whole milk · Vanilla syrup · Ice · Blended until smooth' },
      { name: 'Toffee Nut Frappe', description: 'Toffee nut blended with ice and coffee.', price: '$5', lbpPrice: '450,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-V92sw4jPopFJUhY0I6CRopiMhJPd3z.png', recipe: 'Double espresso · Cold whole milk · Toffee-nut syrup · Ice · Blended until smooth' },
      { name: 'Oliva Frappe', description: 'Our signature house-special frappe.', price: '$5', lbpPrice: '450,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-bbYGextJha6eEyKhj4PdXN57IHwUl6.png', recipe: 'Double espresso · Cold whole milk · Oliva signature flavor · Ice · Blended until smooth' },
    ],
  },
  {
    id: 'iced-latte',
    ...
    drinks: [
      { name: 'Iced Spanish Latte', description: 'Condensed milk sweetness over iced espresso.', price: '$3.50', lbpPrice: '400,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-1A9jSkBMZQQTChO85ByHAFjMXR4xFl.png', recipe: 'Double espresso · Cold whole milk · Sweetened condensed milk · Ice' },
      { name: 'Iced Mocha Latte', description: 'Chocolate and espresso over ice.', price: '$3.50', lbpPrice: '400,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Rr4c9LxQmhblzgfiYOvwxMvOIKa6hl.png', recipe: 'Double espresso · Cold whole milk · Chocolate sauce · Ice' },
      { name: 'Iced Latte (Vanilla, Hazelnut, Salted Caramel)', description: 'Choose your favorite flavor over ice.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-xTfJ6LFapgpfO1LyhDQWMhHXu9DWu6.png', recipe: 'Double espresso · Cold whole milk · Choice of: Vanilla syrup / Hazelnut syrup / Salted-caramel syrup · Ice' },
      { name: 'Irish Cream Latte', description: 'Irish cream flavor over iced espresso.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-9SNq0XJxkj4jDX9BPJYdhro9oBkYfR.png', recipe: 'Double espresso · Cold whole milk · Non-alcoholic Irish-cream syrup · Ice' },
      { name: 'Caramel Macchiato', description: 'Vanilla and caramel over iced espresso.', price: '$3.50', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-EzCxMy5OY10OgFIMIO6yp3aNpJLNMS.png', recipe: 'Double espresso · Cold whole milk · Vanilla syrup · Caramel drizzle · Ice' },
      { name: 'Iced Matcha Latte', description: 'Stone-ground matcha whisked with cold milk.', price: '$4', lbpPrice: '350,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-KEVrxkxgtVF8BYCASuyNzMyJQ9PKK0.png', recipe: 'Matcha green tea · Cold whole milk · Light sweetener · Ice' },
    ],
  },
  {
    id: 'refreshers',
    ...
    drinks: [
      { name: 'Razzlychee Iced Tea', description: 'Raspberry and lychee iced tea.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-bRQLbVsikSW2ZWnjqH1VSWWdS4xUdP.png', recipe: 'Black tea · Raspberry flavor · Lychee flavor · Ice' },
      { name: 'Tropical Iced Tea', description: 'Tropical fruit iced tea.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-7i5TcZR6dEALoXdeObmDp45KOg9wU4.png', recipe: 'Black tea · Tropical fruit flavors · Fruit syrup · Ice' },
      { name: 'Peach Iced Tea', description: 'Refreshing peach iced tea.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-8HJ5G3p17tU3Vt5uYpASaP3IpI7Lac.png', recipe: 'Black tea · Peach flavor · Light sweetener · Ice' },
      { name: 'Kiwi Mojito', description: 'Kiwi and mint mocktail, crisp and cool.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-5rt87GEZDjmTtPCUeSwUExpuGr1KmZ.png', recipe: 'Kiwi · Fresh lime · Fresh mint · Sparkling water · Ice' },
...
export const hotDrinksSubcategories: Subcategory[] = [
  {
    ...
    drinks: [
      { name: 'Café Latte (Vanilla, Hazelnut)', description: 'Smooth espresso with silky steamed milk.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_drink_with_cafe_latte_202607232038-sILwH2u7ucm7zxNQAC2O01CToZpFtE.jpeg', recipe: 'Double espresso · Steamed whole milk · Choice of: Vanilla syrup / Hazelnut syrup · Thin velvety microfoam' },
      { name: 'Hot Chocolate', description: 'Rich dark cocoa with steamed milk and a touch of cream.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_cub_with_hot_chocolat_202607232038-ITId7cFtZGHzdKXocxmd6zYk8ZaNbA.jpeg', recipe: 'Chocolate or cocoa · Steamed whole milk · Light milk foam · Whipped cream' },
      { name: 'Cappuccino', description: 'Velvety microfoam over a double espresso shot.', price: '$3', lbpPrice: '300,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_cub_design_with_white_202607232112-q3frxaTSt5VAZ2p4JNC9ZchDWhvYS9.jpeg', recipe: 'Double espresso · Steamed whole milk · Thick velvety microfoam · Equal parts espresso, milk and foam' },
      { name: 'Espresso', description: 'Rich single-origin shot, bold and intensely aromatic.', price: '$1.50', lbpPrice: '100,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Replace_cub_with_espresso_cub_202607232041-DuTLgmfeNonKQ3t469sh1OztnIlMS8.jpeg', recipe: 'Freshly ground coffee · Hot water under pressure · Concentrated coffee shot · Natural crema' },
      { name: 'Tea', description: 'Fresh garden tea leaves steeped to perfection.', price: '$1.50', lbpPrice: '100,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Mint%20Tea%20-%20Healthier%20Steps-K09FCIl8LarX2J4jW8Xjz2jdz4SGtN.jpg', recipe: 'Black tea leaves · Hot water · Sugar optional · Lemon optional' },
      { name: 'Ginger and Honey', description: 'Warm ginger with soothing honey.', price: '$1.50', lbpPrice: '150,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/%F0%9F%8D%B5%E2%9C%A8%20Boost%20your%20wellness%20with%20Turmeric%20Ginger%20Detox%E2%80%A6-ZuXGzKnSKAtkGGw6dF8zluNlgAMTZb.jpg', recipe: 'Fresh ginger · Hot water · Honey · Lemon optional' },
      { name: 'Chamomile', description: 'Relaxing chamomile flowers steeped to calm.', price: '$1.50', lbpPrice: '150,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/5%20motivos%20para%20tomar%20ch%C3%A1%20de%20camomila-krP5Rh6ygGTtzKuGO8YcYO9HoI9VgX.jpg', recipe: 'Chamomile flowers · Hot water · Honey optional' },
      { name: 'Green Tea', description: 'Fresh green tea with natural antioxidants.', price: '$1.50', lbpPrice: '150,000 LBP', image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Download%20Cup%20of%20tea%20with%20mint%20leaves%20on%20transparent%20background%20for%20free-dVWvZk3WigRlkFEKZQtfcDFOwMcIY0.jpg', recipe: 'Green tea leaves · Hot water · Honey optional' },
    ],
  },
]
