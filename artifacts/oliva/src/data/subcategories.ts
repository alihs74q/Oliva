...
export const coldDrinksSubcategories: Subcategory[] = [
  ...
  },
  {
    ...
    drinks: [
      ...
      { name: 'Strawberry Whip', description: 'Fresh strawberries with whipped cream.', price: '$4', lbpPrice: '350,000 LBP', image: '/strawberry-whip-milkshake.png', recipe: 'Vanilla ice cream · Cold whole milk · Strawberry purée · Whipped cream' },
      { name: 'Choco-Nut Milkshake', description: 'Chocolate and nut blend, rich and creamy.', price: '$4', lbpPrice: '350,000 LBP', image: '/choconut-milkshake.png', recipe: 'Vanilla ice cream · Cold whole milk · Chocolate · Hazelnut flavor' },
      { name: 'Vanilla Milkshake', description: 'Classic vanilla bean milkshake.', price: '$4', lbpPrice: '350,000 LBP', image: '/vanilla-milkshake.png', recipe: 'Vanilla ice cream · Cold whole milk · Vanilla flavor' },
      { name: 'Lotus Milkshake', description: 'Lotus biscuit blended into creamy indulgence.', price: '$4.50', lbpPrice: '400,000 LBP', image: '/lotus-milkshake.png', recipe: 'Vanilla ice cream · Cold whole milk · Lotus Biscoff spread · Crushed Lotus biscuits' },
...
export const hotDrinksSubcategories: Subcategory[] = [
  {
    ...
    drinks: [
      { name: 'Café Latte (Vanilla, Hazelnut)', description: 'Smooth espresso with silky steamed milk.', price: '$3', lbpPrice: '300,000 LBP', image: '/cafe-latte.png', recipe: 'Double espresso · Steamed whole milk · Choice of: Vanilla syrup / Hazelnut syrup · Thin velvety microfoam' },
      { name: 'Hot Chocolate', description: 'Rich dark cocoa with steamed milk and a touch of cream.', price: '$3', lbpPrice: '300,000 LBP', image: '/hot-chocolate.png', recipe: 'Chocolate or cocoa · Steamed whole milk · Light milk foam · Whipped cream' },
      { name: 'Cappuccino', description: 'Velvety microfoam over a double espresso shot.', price: '$3', lbpPrice: '300,000 LBP', image: '/cappuccino.jpeg', recipe: 'Double espresso · Steamed whole milk · Thick velvety microfoam · Equal parts espresso, milk and foam' },
      { name: 'Espresso', description: 'Rich single-origin shot, bold and intensely aromatic.', price: '$1.50', lbpPrice: '100,000 LBP', image: '/espresso.png', recipe: 'Freshly ground coffee · Hot water under pressure · Concentrated coffee shot · Natural crema' },
      { name: 'Tea', description: 'Fresh garden tea leaves steeped to perfection.', price: '$1.50', lbpPrice: '100,000 LBP', image: '/tea.png', recipe: 'Black tea leaves · Hot water · Sugar optional · Lemon optional' },
      { name: 'Ginger and Honey', description: 'Warm ginger with soothing honey.', price: '$1.50', lbpPrice: '150,000 LBP', image: '/ginger-honey.png', recipe: 'Fresh ginger · Hot water · Honey · Lemon optional' },
      { name: 'Chamomile', description: 'Relaxing chamomile flowers steeped to calm.', price: '$1.50', lbpPrice: '150,000 LBP', image: '/chamomile.png', recipe: 'Chamomile flowers · Hot water · Honey optional' },
      { name: 'Green Tea', description: 'Fresh green tea with natural antioxidants.', price: '$1.50', lbpPrice: '150,000 LBP', image: '/green-tea.png', recipe: 'Green tea leaves · Hot water · Honey optional' },
    ],
  },
]
