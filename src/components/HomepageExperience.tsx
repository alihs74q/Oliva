...
export default function HomepageExperience({
  ...
  const cards: CatCard[] = [
    ...
    { id: 'shisha', label: 'Shisha', desc: 'Premium flavors', gradient: 'linear-gradient(135deg,#eab308,#a16207)', accent: '#fef08a', image: 'https://images.pexels.com/photos/18781628/pexels-photo-18781628/free-photo-of-hookah-with-purple-pipes.jpeg?auto=compress&cs=tinysrgb&w=400', onClick: onShisha },
    { id: 'sandwiches', label: 'Sandwiches', desc: 'Fresh & delicious', gradient: 'linear-gradient(135deg,#f97316,#dc2626)', accent: '#fed7aa', image: 'https://images.pexels.com/photos/3407881/pexels-photo-3407881.jpeg?auto=compress&cs=tinysrgb&w=400', onClick: onSandwiches },
    { id: 'yogurt', label: 'Yogurt', desc: 'Creamy & refreshing', gradient: 'linear-gradient(135deg,#d946ef,#be185d)', accent: '#f9a8d4', image: 'https://images.pexels.com/photos/5632399/pexels-photo-5632399.jpeg?auto=compress&cs=tinysrgb&w=400', onClick: onYogurt },
  ]
